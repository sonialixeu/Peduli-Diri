...
<html lang="en">
  ...
  <body class="text-center" style="background-image : url('{{asset('img/bg.jpg')}}')">
  <div class="container">
          ...
          <div class="card-body">
            ...
            <form class="form-signin" method="POST" action="{{ route('register') }}">
              ...
              <div class="form-group">
                ...
                <input type="text" id="inputName" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" name="name" placeholder="Nama Lengkap" required value="{{ old('name') }}">
                @if ($errors->has('name'))
                <div class="invalid-feedback">
                  {{ $errors->first('name') }}
                </div>
